...
{
    delete [] m_data;
    //we dont need yo set m_data to null or m_length to 0 here
    //since the object will be destroyed immediately
}
...
void IntArray::erase()
{
    ...
    //we need to make sure we set m_data to nullprt here
    m_data = nullptr;
    m_length = 0;
}
